...
Vandaag is voornamelijk een herhaling van gister, alleen dan langer. Veel langer. Heb zo'n 2,5 uur aan het logboek gewerkt. Dat duurde extreem lang, maar nu is het allemaal wel bijgewerkt. Uiteindelijk ben ik nog een tijd lang bezig geweest met de uiteindelijk analyses uitvoeren op mijn plotjes aangezien er nog een deel van ontbreekte. 
...
### Resultaten/stand van zaken:
Ik heb nu al mijn analyses af en ben volledig bijgewerkt met mijn logboek.


### Conclusie en vervolgstappen:
Nu ik mijn eigen onderdelen af heb kan ik volledig focussen op alles samenvoegen met mijn teamgenoten in publicatie.Rmd
We moeten nog de discussie, conclusie, resultaten, README, bronvermelding, repo structuur op orde krijgen voor morgen.
...
### Doel:
Het onderzoek afronden. Er moet nog veel gebeuren, netjes alles schrijven in resultaten en publicatie.Rmd.
Goed beschrijven wat er in elk plot te zien valt. De discussie, conclusie, resultaten, README, bronvermelding, repo structuur moet ook af zijn.

### Motivatie:
Het project moet vandaag af zijn, dus alle bovenstaande dingen bij het 'doel' moet nu echt gedaan worden. Taken worden onderverdeeld onder ons.


### Werkzaamheden:
Ik ben bezig geweest met de plots in publicatie.Rmd krijgen, vervolgens heb ik aan de omschrijving wat er in dat plotje te zien is gewerkt
en wat de statistische uitkomst was van de test per plotje en wat dit inhoudt. Dit duurde aanzienlijk lang bleek uiteindelijk, want ik liep een beetje vast
met hoe dit genoteerd moest worden in de resultaten. Ook had ik het niet netjes in bloodpressure.Rmd gezet voorheen, waardoor alle statistische data niet super gemakkelijk terug te vinden was. Zodra dit klaar was heb ik de conclusie aangepast op de bevindingen uit mijn resultaten. Ik heb nog geholpen met de bron vermelding en de repo structuur aangepast zodat het overzichtelijker was (figures folder). 
...
Data: analysis/logboek_tristan/logboek_tristan.Rmd (repo), publication/publicatie.Rmd (repo), word document (online, bovenaan)


### Resultaten/stand van zaken:
Resultaten af, conclusie af, repo af
