...
Uit de resultaten bleek dat de hartslag alleen een significant verschil had tussen geen en lichte tijdsdruk (p = 0.00069) en tussen lichte en hoge tijdsdruk (p = 0.02253), maar niet tussen geen en hoge tijdsdruk (p = 0.92782). Dit wijst op een niet-lineaire fysiologische respons, mogelijk door gewenning. De diastolische bloeddruk vertoonde geen significante verandering over de condities (F(3, 57) = 2.11, p = .110). De systolische bloeddruk was bij toets 2 (lichte tijdsdruk) significant hoger dan in rust (+4,25 mmHg, p = .008) en hoger dan bij toets 1 (+3,7 mmHg, p = .007). Er werd geen significant verschil gevonden tussen man en vrouw in hartslag (p = 0.325) of bloeddruk (p = 0.116 voor systolisch; p = 0.055 voor diastolisch). De PSS-10 score toonde geen significante correlatie met de hartslag of bloeddrukveranderingen tijdens de drie condities. De conclusie is dat tijdsdruk geen eenduidige of lineaire fysiologische stressreactie veroorzaakt, met uitzondering van een tijdelijke stijging van de systolische bloeddruk bij lichte tijdsdruk.
...
systolische bloeddruk, F(3, 57) = 3.68, p = .017, ges = .0142 (1,4% verklaarde variantie).
